        ...
        <div class="wrap-login100">
            ...
            <div class="login100-form validate-form">
                ...
                <span class="form-span-title">
                    <?php if (isset($check_admin)) { echo htmlspecialchars($check_admin); } ?>
                </span><br>
                <!--=====FORM INPUT TÀI KHOẢN VÀ PASSWORD======-->
                <form action="login.php" method="POST">
                    <div class="wrap-input100 validate-input">
                        <input class="input100" type="text" placeholder="Tài khoản quản trị" name="username" required>
            ...
            <div class="text-center p-t-70 txt2">
                ...
                <a class="txt2" href=""> Code bởi Nhóm 9 </a>
            </div>
        </div>
    </div>
</div>
